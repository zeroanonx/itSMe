...
const RetinaLineCom = styled.div`
  .line-container {
    height: 200px;
    overflow-y: auto;
    background: var(--c-bg);
...
export default function RetinaLine() {
  return (
    <RetinaLineCom>
      <div className="line-container">
        <div className="border_normal line-div">
          正常使用1px border效果（本DEMO请在移动端环境下查看）
        </div>
        <div className="border_gradient line-div">
          法一：使用渐变实现，使用两种颜色填充 1px 宽内容
        </div>
        <div className="border_scale line-div">
          法二：使用缩放实现，对 1px 高度线条进行0.5倍缩放
        </div>
        <div className="border_base64 line-div">法三：base64 编码实现</div>
      </div>
    </RetinaLineCom>
  );
}

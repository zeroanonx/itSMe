  ...
  return (
    <div className="right flex items-center gap-x-4 md:gap-x-8">
      ...
      >
        ...
        <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 bg-linear-to-r from-amber-400/30 to-orange-400/30 blur-sm scale-150 transition-all duration-300 animate-pulse"></div>

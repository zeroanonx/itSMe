    ...
    return (
      <CursorStyles>
        ...
        >
          ...
          />
          <div
            className="absolute border-[3px] border-primary border-r-0 border-b-0 w-3 h-3 target-cursor-corner"
            style={{
              willChange: "transform",
              left: "50%",
              top: "50%",
          ...
          />
          <div
            className="absolute border-[3px] border-primary border-b-0 border-l-0 w-3 h-3 target-cursor-corner"
            style={{
              willChange: "transform",
              left: "50%",
              top: "50%",
          ...
          />
          <div
            className="absolute border-[3px] border-primary border-t-0 border-l-0 w-3 h-3 target-cursor-corner"
            style={{
              willChange: "transform",
              left: "50%",
              top: "50%",
          ...
          />
          <div
            className="absolute border-[3px] border-primary border-t-0 border-r-0 w-3 h-3 target-cursor-corner"
            style={{
              willChange: "transform",
              left: "50%",
              top: "50%",
